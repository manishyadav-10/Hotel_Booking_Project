...
const RoomDetails = () => {
    ...
    const checkAvailability = async()=>{
        try{
            //   Check is Check-In Date is greter than Check-Out date
...
<div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
     ...
     <div className='flex flex-col'>
        ...
        className='max-w-20 
        rounded border border-gray-300 px-3 py-3 mt-1.5 outline-none' 
        required />
    </div>

</div>
<button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all
text-white rounded-md max-md:w-full 
...
<div className='mt-25 space-y-4'>
 ...
 <div>
    <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        ...
        You get a comfottable Two bedrooms apatment has a true city feeling. The 
        price quoted is for the exact price for groups. The Guests will be allocated 
        ground floor according to availability. You get the comfortable
         two bedrooms apartment that has a true city feeling.
    </p>
 </div>
