    ...
    justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32 bg-white'>
      <div>
       <div className='flex flex-col items-start text-left'>
        ...
        Take adavntage of our limited-time offers and 
              ...
              className='max-h-65 md:w-1/2 rounded-xl shadow-lg
               ...
               <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                <div className='flex items-center gap-1 text-gray-500 mt-2 text-sm'>
                  ...
                  className='' /> <span>{room.hotel.address}</span>
                </div>
                {/* Room Amenities */}
      ...
      max-lg:mb-8 min-lg:mt-16'>
        ...
        <div className={`flex itmes-center justify-between px-5 py-2.5
          min-lg:border border-gray-300 ${openFilters && "border-b"}`}>
